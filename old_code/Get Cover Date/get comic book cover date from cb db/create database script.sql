DROP TABLE collectorz_invoice_input;
CREATE TABLE collectorz_invoice_input (cii_id INTEGER NOT NULL, eh_id INTEGER NOT NULL, cii_release_dt TEXT, cii_cover_dt_disp TEXT, cii_cover_dt TEXT, cii_series TEXT NOT NULL, cii_issue TEXT, cii_issue_no TEXT, cii_issue_ext TEXT, cii_edition TEXT, cii_full_title TEXT, computed_issue_num TEXT NOT NULL, lookup_status TEXT, PRIMARY KEY (cii_id));
CREATE INDEX cii_eh_id ON collectorz_invoice_input (eh_id);
DROP TABLE execution_history;
CREATE TABLE execution_history (eh_id INTEGER NOT NULL, exec_dt TEXT NOT NULL, is_id INTEGER NOT NULL, exec_status TEXT NOT NULL, PRIMARY KEY (eh_id));
CREATE INDEX eh_is_id ON execution_history (is_id);
DROP TABLE internet_sources;
CREATE TABLE internet_sources (is_id INTEGER NOT NULL, is_name TEXT NOT NULL, is_base_url TEXT NOT NULL, is_series_index_page TEXT NOT NULL, crt_dt TEXT NOT NULL, updt_dt TEXT NOT NULL, PRIMARY KEY (is_id), UNIQUE (is_name), UNIQUE (is_base_url, is_series_index_page));
...
CREATE UNIQUE INDEX sqlite_autoindex_internet_sources_2 ON internet_sources (is_base_url, is_series_index_page);
CREATE UNIQUE INDEX sqlite_autoindex_internet_sources_1 ON internet_sources (is_name);
DROP TABLE is_series_header;
CREATE TABLE is_series_header (ish_id INTEGER NOT NULL, eh_id INTEGER NOT NULL, ser_id INTEGER NOT NULL, PRIMARY KEY (ish_id), UNIQUE (eh_id, ser_id));
CREATE INDEX ish_eh_id ON is_series_header (eh_id);
CREATE INDEX ish_ser_id ON is_series_header (ser_id);
CREATE UNIQUE INDEX sqlite_autoindex_is_series_header_1 ON is_series_header (eh_id, ser_id);
DROP TABLE is_series_ids;
CREATE TABLE is_series_ids (issi_id INTEGER NOT NULL, ser_id INTEGER NOT NULL, is_id INTEGER NOT NULL, issi_series_id INTEGER NOT NULL, crt_dt TEXT NOT NULL, updt_dt TEXT NOT NULL, PRIMARY KEY (issi_id), UNIQUE (ser_id, is_id), UNIQUE (is_id, issi_series_id));
...
CREATE UNIQUE INDEX sqlite_autoindex_is_series_ids_2 ON is_series_ids (is_id, issi_series_id);
CREATE UNIQUE INDEX sqlite_autoindex_is_series_ids_1 ON is_series_ids (ser_id, is_id);
DROP TABLE is_series_index;
CREATE TABLE is_series_index (isi_id INTEGER NOT NULL, ish_id INTEGER NOT NULL, isi_issue_id INTEGER NOT NULL, isi_issue_type TEXT NOT NULL, isi_issue_num TEXT NOT NULL, isi_issue_name TEXT, isi_variant_seq INTEGER NOT NULL, isi_variant_desc TEXT, isi_cover_dt_disp TEXT, isi_cover_dt TEXT, isi_story_arc TEXT, isi_story_arc_id INTEGER, PRIMARY KEY (isi_id), UNIQUE (ish_id, isi_issue_id), UNIQUE (ish_id, isi_issue_num, isi_variant_seq));
CREATE INDEX isi_ish_id ON is_series_index (ish_id);
CREATE UNIQUE INDEX sqlite_autoindex_is_series_index_2 ON is_series_index (ish_id, isi_issue_num, isi_variant_seq);
CREATE UNIQUE INDEX sqlite_autoindex_is_series_index_1 ON is_series_index (ish_id, isi_issue_id);
DROP TABLE series;
CREATE TABLE series (ser_id INTEGER NOT NULL, ser_name TEXT NOT NULL, ser_name_sort TEXT, ser_year INTEGER NOT NULL, ser_cover_price REAL NOT NULL, cii_series TEXT NOT NULL, crt_dt TEXT NOT NULL, updt_dt TEXT NOT NULL, PRIMARY KEY (ser_id), UNIQUE (ser_name, ser_year), UNIQUE ());
...
CREATE UNIQUE INDEX sqlite_autoindex_series_2 ON series (cii_series);
CREATE UNIQUE INDEX sqlite_autoindex_series_1 ON series (ser_name, ser_year);
DROP TABLE sqlite_sequence;
CREATE TABLE sqlite_sequence (name , seq );
INSERT INTO sqlite_sequence (name, seq) VALUES ('series', 42);
INSERT INTO sqlite_sequence (name, seq) VALUES ('internet_sources', 1);
INSERT INTO sqlite_sequence (name, seq) VALUES ('is_series_ids', 42);
ALTER TABLE collectorz_invoice_input ADD CONSTRAINT  FOREIGN KEY (eh_id) REFERENCES execution_history (eh_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE execution_history ADD CONSTRAINT  FOREIGN KEY (is_id) REFERENCES internet_sources (is_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE is_series_header ADD CONSTRAINT  FOREIGN KEY (ser_id) REFERENCES series (ser_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE is_series_header ADD CONSTRAINT  FOREIGN KEY (eh_id) REFERENCES execution_history (eh_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE is_series_ids ADD CONSTRAINT  FOREIGN KEY (is_id) REFERENCES internet_sources (is_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE is_series_ids ADD CONSTRAINT  FOREIGN KEY (ser_id) REFERENCES series (ser_id) ON UPDATE NO ACTION ON DELETE CASCADE;
ALTER TABLE is_series_index ADD CONSTRAINT  FOREIGN KEY (ish_id) REFERENCES is_series_header (ish_id) ON UPDATE NO ACTION ON DELETE CASCADE;
