<?php
$ctrys = array(
"zz" => "(Unknown)",                 "xx" => "-- Fix Me --",                     "af" => "Afghanistan",                    "al" => "Albania",                               "dz" => "Algeria", 
...
"cg" => "Congo",                     "ck" => "Cook Islands",                     "cr" => "Costa Rica",                     "ci" => "Cote D&#39;Ivoire (Ivory Coast)",       "hr" => "Croatia (Hrvatska)", 
"cu" => "Cuba",                      "cy" => "Cyprus",                           "cz" => "Czech Republic",                 "cshh" => "Czechoslovakia (Former)",             "dk" => "Denmark", 
"dj" => "Djibouti",                  "dm" => "Dominica",                         "do" => "Dominican Republic",             "tp" => "East Timor",                            "ec" => "Ecuador", 
"eg" => "Egypt",                     "sv" => "El Salvador",                      "gq" => "Equatorial Guinea",              "er" => "Eritrea",                               "ee" => "Estonia", 
"et" => "Ethiopia",                  "fk" => "Falkland Islands (Malvinas)",      "fo" => "Faroe Islands",                  "fj" => "Fiji",                                  "fi" => "Finland", 
"fr" => "France",                    "fx" => "France, Metropolitan",             "gf" => "French Guiana",                  "pf" => "French Polynesia",                      "tf" => "French Southern Territories", 
"ga" => "Gabon",                     "gm" => "Gambia",                           "ge" => "Georgia",                        "ddde" => "German Democratic Republic [Former]", "de" => "Germany", 
"gh" => "Ghana",                     "gi" => "Gibraltar",                        "gb" => "Great Britain (Uk)",             "gr" => "Greece",                                "gl" => "Greenland", 
...
"an" => "Netherlands Antilles",      "nt" => "Neutral Zone",                     "nc" => "New Caledonia",                  "nz" => "New Zealand (Aotearoa)",                "ni" => "Nicaragua", 
...
"ro" => "Romania",                   "ru" => "Russian Federation",               "rw" => "Rwanda",                         "gs" => "S. Georgia And S. Sandwich Isls.",      "kn" => "Saint Kitts And Nevis", 
...
"sk" => "Slovak Republic",           "si" => "Slovenia",                         "sb" => "Solomon Islands",                "so" => "Somalia",                               "za" => "South Africa", 
"es" => "Spain",                     "lk" => "Sri Lanka",                        "sh" => "St. Helena",                     "pm" => "St. Pierre And Miquelon",               "sd" => "Sudan",
...
"ua" => "Ukraine",                   "ae" => "United Arab Emirates",             "uk" => "United Kingdom",                 "us" => "United States",                         "uy" => "Uruguay", 
"um" => "Us Minor Outlying Islands", "suhh" => "Ussr (Former)",                  "uz" => "Uzbekistan",                     "vu" => "Vanuatu",                               "va" => "Vatican City State (Holy See)", 
"ve" => "Venezuela",                 "vn" => "Viet Nam",                         "vg" => "Virgin Islands (British)",       "vi" => "Virgin Islands (U.S.)",                 "wf" => "Wallis And Futuna Islands", 
"eh" => "Western Sahara",            "ye" => "Yemen",                            "yu" => "Yugoslavia",                     "zr" => "Zaire",                                 "zm" => "Zambia", 
"zw" => "Zimbabwe");
?>